    ...
    return (
        <div >
            ...
            <div className="hidden md:block w-[40vw] h-screen bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
                ...
                <div className="w-48 h-56 rounded-[20px] border-fuchsia-600 absolute top-[30%] -right-10  " />
                ...
                <img src={CARD_2} alt="track transcation chart presentation.."
                    className="w-64 lg:w-[98%] absolute bottom-10 shadow-lg shadow-blue-400/15"
                />
